...
and order one at a time. And they are paying with either a $25, $50, or $100
notes.
...
we only have two $50 notes. Since not every person in the queue received the ticket 
and balance, the answer is false.
*/
import java.util.*;
import java.lang.*;
class day16p3{
