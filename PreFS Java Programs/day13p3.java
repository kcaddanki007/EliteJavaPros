...
// Do this with the logic where 2 numbers can be represented as one number with 
//quotient and remainder with a number bigger than the biggest number in the set
import java.util.*;
import java.lang.*;
class day13p3{
