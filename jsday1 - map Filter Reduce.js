...
function mrf(empList){
    ...
    var finsal = empList.map((n) => {
        if(n.sal>50) return n.sal+=n.sal*0.15;
        else if(n.sal>30 && n.sal<=50) return n.sal+= n.sal*0.2;
        else return n.sal+=n.sal*0.25;
    });
    
    //console.log(finsal);
    
    var retainsal = finsal.filter((n)=>{
        return n<=50;
    });
    //console.log(retainsal);    
    
    var high = retainsal.reduce((max,high)=>{
